...
def objective(batched_data_hor, batched_params, batched_data_ver):
    ...
    lw_spl_sub_h  = spl_hor[:, 0, REF_0:REF_60, :]  
    lw_freq_sub_h = freq_hor[:, 0, REF_0:REF_60, :]
    ...
    lw_spl_sub_v  = spl_ver[:, 0, REF_0:REF_60, :]  
    lw_freq_sub_v = freq_ver[:, 0, REF_0:REF_60, :]
...
class ParticleSwarmOptimizer:
    ...
    def _create_bounds(self):
        ...
        # 인덱스 75~79
        bounds_list.append([100.0, 1000.0])   # index 75
        bounds_list.append([100.0, 1000.0])  # index 76
        bounds_list.append([100.0, 1000.0])   # index 77
        bounds_list.append([0.0,   1000.0])   # index 78
